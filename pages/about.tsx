    ...
    return (
        <>
            ...
            <div className="min-h-screen flex flex-col mx-10">
                ...
                <div className="xl:hidden mt-10 flex-auto w-1/2 lg:w-1/3 border-solid border-2 border-white rounded-sm xl:w-full profile-img self-center" style={{ backgroundColor: backgroundColor }}>
                ...
                <div className="flex m-10 profile">
                    ...
                    <div className="w-1/3 flex flex-col">
                        ...
                        <span className="profile-item-2" style={{ backgroundColor: backgroundColor }}>
                            ...
                            engineer. <strong>My days are mostly filled with coding and studying</strong>, since these things seem to make me happy, and neither can lift more
                            than me 😄.
                        </span>
                    </div>
                </div>
